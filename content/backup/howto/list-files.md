...
- **-subdir=yes**: List all under the specified directory, recursively. 
  Without this option, dsmc will only show direct descendants. (<a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-subdir" target="_blank">docs</a>)
...
More information can be found <a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=commands-query-backup" target="_blank">here</a>.

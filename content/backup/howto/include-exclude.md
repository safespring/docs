...
topic, [explained here](https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=options-compression-encryption-backup-processing).
...
* <a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-include-options" target="_blank">All details on includes and excludes on the IBM website</a>
* <a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-domain" target="_blank">Details on the DOMAIN option</a>

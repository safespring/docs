...
The `passwordaccess` option: <a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-passwordaccess" target="_blank">IBM Documentation</a>
...
### Further reading
Password storage: <a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=started-secure-password-storage" target="_blank">IBM Documentation</a>
...
More about `dsmc set password`: <a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=commands-set-password" target="_blank">IBM Documentation</a>

...
- DEDUP_AND_COMPRESS: Enables client-side deduplication and compression by 
  ...
  dsm.opt / dsm.sys):
     - <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-compressalways">COMPRESSALWAYS</a> yes
     - <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-compression">COMPRESSION</a> yes
     - <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-deduplication">DEDUPLICATION</a> yes
- FORCE_ENCRYPT: Forces client-side encryption of all data. Please see the 
  ...
  details. Only one option is (forcefully) set:
     - <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-include-options">INCLUDE.ENCRYPT</a> /.../*
...
<a href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=commands-naming-storage-protect-objects" target="_blank">object naming rules</a>.

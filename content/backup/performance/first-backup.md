...
```
Source: <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=commands-incremental">
...
**(*)** A local deduplication cache (<a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=reference-enablededupcache">docs</a>), which is enabled by default, helps 
...
!!! note
      ...
      are referring to <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=use-file-backup-techniques#r_client_bup_method_filebackup__prog_incr__title__1">
...
```
Source: <a target="_blank" href="https://www.ibm.com/docs/en/storage-protect/8.2.1?topic=commands-selective">

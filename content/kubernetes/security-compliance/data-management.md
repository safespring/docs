...
Automatic backups are created of the management infrastructure: control-plane etcd, as well as [Zitadel IAM](https://zitadel.com/) database, Safespring on-demand Kubernetes Load-balanacer as well as the [Harbor Registry](https://goharbor.io/) database.
